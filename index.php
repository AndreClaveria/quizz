...
<body>
    <form method="post" action="recup.php">
        ...
        <p>Pour les 3 premières question ne pas oubliez la majuscule du début et les accents si il-y-en-a.</p>
        <br />
        ...
        <label for="q4">4: Qui a accomplis les 12 travaux dans la mythologie grecque</label>
        <br />
        <select name="question4" required id="q4" >
