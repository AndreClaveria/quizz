<?php
/*
echo("Réponse à la question 1 : ".$_POST["question1"]);
echo("<br>");
echo("Réponse à la question 2 : ".$_POST["question2"]);
echo("<br>");
echo("Réponse à la question 3 : ".$_POST["question3"]);
echo("<br><br>");
*/
...
if (($_POST["question1"]) == "Salamèche") 
{ 
    $score++;
}
if (($_POST["question2"]) == "Naruto") //strtolower pour eviter les fautes avec Naruto, nARUTO, NARUTO, etc...
{
    $score++;
}
if (($_POST["question3"]) == "Luffy") 
{
    $score++;
}
